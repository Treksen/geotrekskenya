...
export default function BlogPostPage() {
  ...
  return (
    <>
      ...
      <section
        style={{
          background: `linear-gradient(135deg, ${post.authorColor}ee, ${post.authorColor}99)`,
          padding: "80px 0 56px",
        }}
      >
      ...
      <section style={{ padding: "64px 0" }}>
        <div
          className="container article-grid"
          style={{
            maxWidth: 860,
            display: "grid",
        ...
        >
          ...
          >
            ...
            <div className="card-flat">
              ...
              >
                Have a question about this topic? We're happy to discuss your
                project.
              </p>
