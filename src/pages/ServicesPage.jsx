...
function ServiceSection({ service, flip }) {
  ...
  return (
    <div id={service.id} ref={ref} className="reveal responsive-2col" style={{
    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            From physical boundary surveys to satellite imagery analysis and
            custom web GIS platforms — everything your organisation needs to
            work confidently with spatial data.
          </p>
          <div
            style={{
              display: "flex",
      ...
      <section style={{ padding: "0 0 64px" }}>
        <div className="container">
          {SERVICES.map((s, i) => (
            <ServiceSection key={s.id} service={s} flip={i % 2 !== 0} />
          ))}
        </div>
      </section>
      ...
      <section className="section" style={{ background: "var(--gray-50)" }}>
        <div className="container">
          <div className="section-header">
            ...
            <p>
              A clear, transparent workflow from first contact to final
              delivery.
            </p>
          </div>
      ...
      <section style={{ background: "var(--green-700)", padding: "72px 0" }}>
        <div
          className="container services-cta-row"
          style={{
            display: "flex",
        ...
        >
          <div>
            ...
            <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: 480 }}>
              We respond to all enquiries within 24 hours. For urgent
