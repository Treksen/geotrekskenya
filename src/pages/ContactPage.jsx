    ...
    <>
      ...
      >
        <div className="container">
          ...
          >
            Tell us what you need. We review every enquiry personally and
            ...
            {/* <div>
              {sent ? (
                ...
                >
                  ...
                  />
                  <h2 style={{ color: "var(--green-800)", marginBottom: 12 }}>
                    Message received!
                  </h2>
                  <p
                    style={{
                  ...
                  >
                    Thank you, {form.name}. We'll review your enquiry and get
                    back to you at <strong>{form.email}</strong> within 24
                    hours.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    We respond within 24 business hours. Your information is
                    kept confidential.
                  </p>
                </form>
              )}
                      ...
                      <div>
                        ...
                        {href ? (
                          <a
                            ...
                            onMouseEnter={(e) =>
                              (e.target.style.color = "var(--green-600)")
                            }
                            onMouseLeave={(e) =>
          ...
          {[
            {
              ...
              a: "For most projects we can mobilise within 5–10 business days. For urgent requirements, call us directly and we'll do our best to accommodate your timeline.",
            },
            {
              q: "Do you work outside Nairobi?",
              a: "Yes — we have delivered projects in all 47 counties and across Uganda, Tanzania, and Rwanda. Field mobilisation costs are included in our project proposals.",
            },
            {
              q: "What deliverable formats do you support?",
              a: "We deliver in any format you need: GeoJSON, Shapefile, GeoPackage, GeoTIFF, DXF, PDF, KMZ, CSV with coordinates, or as a hosted web map. We discuss your requirements upfront.",
            },
            {
              q: "Are your surveyors ISK-registered?",
              a: "Yes. All boundary and cadastral surveys are conducted by or under the supervision of registered members of the Institution of Surveyors of Kenya (ISK).",
            },
            {
              q: "Can you work with our existing data?",
              a: "Absolutely. Most projects involve integrating with existing data. We assess incoming data quality as part of the scoping process and flag any issues before work begins.",
            },
          ].map(({ q, a }, i) => (
            <div
              key={i}
            ...
            >
              <h4 style={{ marginBottom: 12, color: "var(--gray-900)" }}>
                {q}
              </h4>
              <p
                style={{
